(function() {
    ...
    function jhiAlertErrorController ($scope, AlertService, $rootScope) {
        ...
        var cleanHttpErrorListener = $rootScope.$on('cleandataApp.httpError', function (event, httpResponse) {
            var i;
            ...
            case 400:
                var errorHeader = httpResponse.headers('X-cleandataApp-error');
                var entityKey = httpResponse.headers('X-cleandataApp-params');
                if (errorHeader) {
